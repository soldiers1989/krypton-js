...
import { DEFAULT_RPC, KAZE_NETWORK, RPC_VERSION } from '../../../src/consts'
...
describe('RPC Client', function () {
  describe('Config', function () {
    it('net', () => {
      const client1 = new RPCClient(KAZE_NETWORK.MAIN)
      client1.net.should.equal(DEFAULT_RPC.MAIN)
      const client2 = new RPCClient(KAZE_NETWORK.TEST)
    ...
    it('version', () => {
      const client1 = new RPCClient(KAZE_NETWORK.MAIN, '1.0.0')
      client1.version.should.equal('1.0.0')
      const client2 = new RPCClient(KAZE_NETWORK.TEST)
      client2.version.should.equal(RPC_VERSION)
      const client3 = () => new RPCClient(KAZE_NETWORK.MAIN, 'a.b.c')
  ...
  describe('Methods', function () {
    ...
    beforeEach(() => {
      client = new RPCClient(KAZE_NETWORK.TEST)
    })
