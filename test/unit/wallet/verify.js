...
describe('Key Verification', function () {
  ...
  it('returns true for valid KEP2', () => {
    valid.kep2s.map((kep) => V.isKEP2(kep).should.be.true)
  })
  ...
  it('returns false for invalid KEP2', () => {
    invalid.kep2s.map((kep) => V.isKEP2(kep).should.be.false)
  })
