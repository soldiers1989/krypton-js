...
import { isPrivateKey, isPublicKey, isWIF, isAddress, isKEP2, isScriptHash } from './verify'
import { encrypt, decrypt } from './kep2'
...
class Account {
  ...
  /**
   * Key encrypted according to KEP2 standard.
   * @type {string}
   */
  get encrypted () {
    if (this._encrypted) {
