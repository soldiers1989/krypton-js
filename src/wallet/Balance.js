...
/**
 * @class Balance
 * @classdesc object describing the coins found within an Account. Look up various balances through its symbol. For example, KAZE or STREAM.
...
class Balance {
  constructor (bal = {}) {
    ...
    /** The symbols of the KEP5 tokens in this Balance. Use this symbol to find the corresponding key in the tokens object. */
  ...
  /**
   * Adds a new KEP-5 Token to this Balance.
   * @param {string} sym - The KEP-5 Token Symbol to refer by.
   ...
   * @param {string} url - KAZE Node to check against.
