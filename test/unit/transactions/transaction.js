...
describe('Transaction', function () {
  ...
  it('create ContractTx', () => {
    ...
    tx.outputs.length.should.equal(1)
    balance.assets.KAZE.unconfirmed.length.should.equal(1)
    balance.assets.KAZE.spent.length.should.equal(1)
  })
  ...
  it('create InvocationTx', () => {
    ...
    balance.assets.STREAM.unconfirmed.length.should.equal(1)
  })
